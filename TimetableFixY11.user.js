...
function Save(){
    ...
    GM.setValue("Sub8Colour",document.getElementById("Sub8").value);
    GM.setValue("Sub9Colour",document.getElementById("Sub9").value);
...
function Calendar(){
    ...
    (async () => {
        try{
            ...
            let colourList = [Sub1Colour,Sub2Colour,Sub3Colour,Sub4Colour,Sub5Colour,Sub6Colour,Sub7Colour,Sub8Colour,Sub9Colour]
            let subjDict = {};
            let colourDict = {};
